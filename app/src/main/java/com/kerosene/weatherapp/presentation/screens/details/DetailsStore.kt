package com.kerosene.weatherapp.presentation.screens.details
...
import com.kerosene.weatherapp.domain.usecase.ChangeFavouriteStateUseCase
import com.kerosene.weatherapp.domain.usecase.GetForecastUseCase
import com.kerosene.weatherapp.domain.usecase.ObserveFavouriteStateUseCase
import com.kerosene.weatherapp.presentation.screens.details.DetailsStore.Intent
import com.kerosene.weatherapp.presentation.screens.details.DetailsStore.Label
import com.kerosene.weatherapp.presentation.screens.details.DetailsStore.State
...
interface DetailsStore : Store<Intent, State, Label> {
    ...
    sealed interface Intent {
        ...
        data object ChangeClickFavouriteStatus : Intent
    }
...
class DetailsStoreFactory @Inject constructor(
    ...
    private inner class ExecutorImpl : CoroutineExecutor<Intent, Action, State, Msg, Label>() {
        override fun executeIntent(intent: Intent, getState: () -> State) {
            when (intent) {
                Intent.ChangeClickFavouriteStatus -> {
                    scope.launch {
                        val state = getState()
