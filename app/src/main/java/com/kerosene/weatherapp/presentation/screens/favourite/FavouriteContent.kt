...
import com.kerosene.weatherapp.presentation.ui.theme.Gradient
import com.kerosene.weatherapp.presentation.ui.theme.Orange
    ...
    LazyVerticalGrid(
        ...
        itemsIndexed(
            ...
            CityCard(
                ...
                index = index,
                onClick = {
                    component.obCityItemClick(item.city)
                }
            )
        }
        item {
